...
{% hint style="success" %}
**Have a confirmed PRRT2 diagnosis? Become a member of the Foundation.**

It takes just a few minutes, and your name is never shared — only de-identified data. Being counted is what lets us open doors a diagnosis alone can't: research collaborations, new partnerships, and clinical trials. Every member makes this community's voice harder to ignore.
{% endhint %}
