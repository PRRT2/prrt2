...
{% hint style="info" %}
We're building the open-source knowledge base for PRRT2 — laying the groundwork in public, with the community as we go. All content is grounded in current published medical data; we're tightening sections and developing our [Alliance Perspectives](perspectives/README.md) as we go. [Join us on the ground floor.](https://facebook.com/groups/prrt2) 🧬
{% endhint %}
