...
In our experience that gap is the real problem: not that PKD is hard to treat, but that it is hard to _recognize_. The features above — the movement trigger, the brevity, the preserved awareness, the warning sensation — are a recognizable signature once someone knows to look for it.
...
* [Benign Familial Infantile Seizures (BFIS)](bfis.md) — the infantile-epilepsy part of the spectrum
* [How to Get Tested](../diagnosis/how-to-get-tested.md) — confirming a PRRT2 diagnosis
