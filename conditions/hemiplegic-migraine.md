...
* [The PRRT2 Spectrum](prrt2-spectrum.md) — the full set of conditions
* [The Sodium Channel Connection](../overview/sodium-channel-connection.md) — why migraine fits a network-stability problem
* [Inheritance & Genetics](../overview/inheritance-and-genetics.md) — how the gene moves through families
