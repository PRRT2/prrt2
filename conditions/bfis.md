...
cover: ../.gitbook/assets/hands.avif
coverY: 0
layout:
  width: default
  cover:
...
# Benign Familial Infantile Seizures (BFIS / SeLIE)

## If you just got this diagnosis
...
**Of all the reasons an infant can have seizures, this is one of the most favorable ones.** The medical literature is consistent on this. In most children, the seizures stop by around age two. Development is expected to be normal. Brain imaging is expected to be normal. Children with this diagnosis grow up, go to school, and are not defined by the weeks you are living through right now.

That is not a platitude and it is not us softening anything. It is the documented natural history of this condition, and it is the single most important thing to know on day one.

The rest of this page is the detail — what the seizures are, why they come in clusters, which medications the evidence actually supports, what happens as your child grows, and the honest edges of what is still unknown.

***

## The name is confusing, and that's not your fault

You may have seen several different names attached to your child's diagnosis. They largely describe the same thing.
...
**SeLIE is the current term.** In 2017 the International League Against Epilepsy replaced the word "benign" with "self-limited" across this family of syndromes, and reaffirmed it in the 2022 classification of neonatal and infantile epilepsy syndromes. The change was deliberate: "self-limited" describes what actually happens — the seizures resolve on their own timeline — without implying that living through them is a mild experience.

If your neurologist says BFIS and your genetic report says SeLIE, they are talking about the same condition.

***

## What the seizures actually look like

This is where descriptions in the literature and what parents actually witness can diverge, so it's worth being precise.

**Timing of onset.** Seizures begin in the first year of life. The most common window is around **four to seven months**, and published series cluster tightly there — one multi-center cohort found a mean onset of 4.1 months, with 83% of infants having their first seizure between two and six months. The broader reported range in the ILAE literature runs from about 3 to 20 months. Onset in the newborn period is uncommon but documented, and those infants generally followed the same favorable course.
...
**Duration.** Individual seizures are typically **brief — under five minutes**, and in most published series well under that. Progression to status epilepticus is rare.

**Fever.** Characteristically these seizures are **afebrile** — they are not fever-driven the way febrile seizures are. In one genetically confirmed cohort, every single first seizure was afebrile. Seizures can still occur in the context of an illness or a fever, and GeneReviews specifically recommends treating fevers promptly in children with this diagnosis.
...
**First — the cluster pattern is diagnostically useful.** Brief, afebrile, clustered seizures in an otherwise normally developing infant is a recognizable signature. It is different from the prolonged, fever-associated, one-sided seizures typical of Dravet syndrome, which is the diagnosis with a genuinely serious prognosis that can overlap in age of onset. Recognizing the pattern early points toward the favorable diagnosis rather than the devastating one.

**Second — the cluster pattern is why so many of these babies end up on medication.** The literature says seizures are "self-limited," which is true over months. It does not mean untreated. In one cohort, more than 90% of infants required anti-seizure medication because the seizure burden in the first year was simply too high to watch and wait. The ILAE's own description acknowledges that seizures "are often frequent and may be difficult to control at onset" even though they resolve. Nearly half of infants in one series needed intravenous medication for rapid control.

If your baby was admitted, given IV medication, and had a hard first few weeks — that is a common course for this condition, not a sign that something worse is happening.

***

## What the tests show — and why "normal" is the answer you want

**Interictal EEG** (the EEG between seizures) is normal in most infants with this diagnosis. Occasionally sporadic focal epileptiform discharges appear — centrotemporal, parietotemporal, or frontocentral spikes have all been reported. An EEG captured during a seizure typically shows onset in temporal, central, parietal, or occipital regions, sometimes spreading.

**Brain MRI** is expected to be normal.

**Neurological examination** between seizures is expected to be normal.

Parents often find this maddening: every test comes back clean while your child is having seizures. But in this diagnosis, normal imaging and a normal interictal EEG are not a failure to find the problem — **they are part of the diagnosis.** They are what distinguishes this from a structural brain abnormality or an epileptic encephalopathy. The abnormality is in a single gene affecting how neurons regulate their own excitability. It does not show up on a picture of the brain.

***

## What the prognosis actually is

The established picture, from GeneReviews and the ILAE literature:

* **Seizures remit in most children by age two.** One review of the published data found 98% of patients in remission before age two, with the remaining small fraction remitting between two and three years.
* **Developmental outcome is normal.** Development before and after seizure onset is expected to be typical.
...
{% hint style="info" %}
**This section describes published evidence, not medical advice.** Anti-seizure medication choice in an infant is a decision for your pediatric neurologist or epileptologist, who knows your child's full picture. Bring this to them — don't act on it alone.
{% endhint %}
...
Rescue medications — most commonly benzodiazepines such as lorazepam, diazepam, or midazolam — are described as **crucial** for seizures lasting more than five minutes and for seizure clusters. If your child has a cluster-prone condition and you do not yet have a written rescue plan, that is a concrete thing to ask for at your next appointment.

### Coming off medication

Because seizures typically subside by age two, there is usually no need for prolonged medication beyond that point. Anecdotal reports suggest seizures can recur if medication is withdrawn during the first year of life, and withdrawal somewhere between **12 and 18 months** has been proposed in the ILAE literature. Timing is your neurologist's call, informed by how your child has responded.

***

## What comes next: the PKD question
...
The genuinely useful thing you can do is **keep the record.** Write down what happened this year — the age at first seizure, the semiology, the medication that worked, the variant name. If movement episodes appear at age nine, that record turns a confusing new symptom into an answered question in a single appointment instead of another diagnostic odyssey.

***

## When it doesn't follow the script

Most of this page describes the typical course. Some children don't follow it, and if yours is one of them you should not have to find that out by noticing you're missing from the reassuring version.

**Seizures continuing past age three.** Uncommon but documented. In one cohort, three of 36 children needed medication for recurrent seizures after age three — including recurrences at ages five, seven, and ten and a half. All were controlled, in each case on a sodium channel blocker.
...
**If you hit a wall.** Ask for a second opinion — you're entitled to one. Contact the nearest children's hospital's neurology department directly, since many accept self-referral or will tell you what they need. The [Child Neurology Foundation](https://www.childneurologyfoundation.org) and [NORD](https://rarediseases.org) both help families locate appropriate specialists, and are listed as resources in the GeneReviews chapter itself. See also [Links & Support](../resources/links-and-support.md).

**Keep your primary care physician.** None of this means going around them. They handle your child's growth, immunizations, illnesses, and the day-to-day — and a good one is genuinely valuable. The point is narrower: for this specific diagnosis, they are the referral route, not the destination.
...
* Do we have a **written seizure action plan** — including rescue medication, dosing, and when to call 911?
* What is the plan if a **cluster** starts at home?
* Why this particular medication for my child, and what would make us switch?
...
You may also find [For Your Doctor](../resources/for-your-doctor.md) useful — it's written to be handed to a clinician who hasn't seen this gene before.
...
So: be the pushy parent. Ask for the referral by name. Ask again at the next visit. Go to the academic center, the movement disorder clinic, the epilepsy program. Get someone who has seen this gene before, even if it means a longer drive and a longer wait. If you are told to wait and see, ask specifically what you would be waiting for and what would change the plan — and if the answer is vague, that is your signal to escalate rather than to relax.
...
* [Treatment for BFIS](../treatments/by-condition/bfis.md) — medication detail and management
